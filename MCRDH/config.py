...
def get_config():
    ...
    parser.add_argument("--n-epochs", type=int, default=80, help="number of epochs to train for")
    ...
    parser.add_argument("--lr-ma", type=float, default=0, help="lr for moving average strategy")

    parser.add_argument("--lambda1", type=float, default=1, help="hyper-parameter for loss TL")
    parser.add_argument("--lambda2", type=float, default=0.1, help="hyper-parameter for loss CL")
